...
for (i in 319:397){
  ...
  if (i == 0 | i == 74) {}
      ...
      tsv_file = paste("/Users/saila/Desktop/Visualization_material/GCN_353/", i,".tsv", sep="")
      if (file.exists(tsv_file)){
        networkInput <- as.matrix(read.csv(tsv_file, header= F, sep = "\t"))     ##Set path
        #REMOVE HEADER
        ...
        write.table(new_gene_pair_file, filename,row.names = F, col.names = c("Gene1",	"Gene2","No",	"Weight",	"Significant"), sep="\t")
      }
      else{}
  }
}
